# Comparing `tmp/gine-0.0.4.tar.gz` & `tmp/gine-0.1.0a0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "gine-0.0.4.tar", last modified: Sun Jun 11 14:06:39 2023, max compression
+gzip compressed data, was "gine-0.1.0a0.tar", last modified: Sat Jun 10 15:56:48 2023, max compression
```

## Comparing `gine-0.0.4.tar` & `gine-0.1.0a0.tar`

### file list

```diff
@@ -1,45 +1,44 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-11 14:06:39.966098 gine-0.0.4/
--rw-r--r--   0 runner    (1001) docker     (123)      383 2023-06-11 14:05:41.000000 gine-0.0.4/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)     2470 2023-06-11 14:06:39.966098 gine-0.0.4/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1356 2023-06-11 14:05:41.000000 gine-0.0.4/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-11 14:06:39.962098 gine-0.0.4/gine/
--rw-r--r--   0 runner    (1001) docker     (123)     1650 2023-06-11 14:05:41.000000 gine-0.0.4/gine/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)       67 2023-06-11 14:05:41.000000 gine-0.0.4/gine/_version.py
--rw-r--r--   0 runner    (1001) docker     (123)     1279 2023-06-11 14:05:41.000000 gine-0.0.4/gine/example.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-11 14:06:39.962098 gine-0.0.4/gine/labextension/
--rw-r--r--   0 runner    (1001) docker     (123)     1859 2023-06-11 14:06:39.000000 gine-0.0.4/gine/labextension/package.json
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-11 14:06:39.962098 gine-0.0.4/gine/labextension/static/
--rw-r--r--   0 runner    (1001) docker     (123)      914 2023-06-11 14:06:39.000000 gine-0.0.4/gine/labextension/static/261.eaa1869df03e402b748a.js
--rw-r--r--   0 runner    (1001) docker     (123)      613 2023-06-11 14:06:39.000000 gine-0.0.4/gine/labextension/static/461.1bd728bc8c28c2dac706.js
--rw-r--r--   0 runner    (1001) docker     (123)     6429 2023-06-11 14:06:39.000000 gine-0.0.4/gine/labextension/static/remoteEntry.e96430acb17957cafa46.js
--rw-r--r--   0 runner    (1001) docker     (123)      118 2023-06-11 14:06:38.000000 gine-0.0.4/gine/labextension/static/style.js
--rw-r--r--   0 runner    (1001) docker     (123)       20 2023-06-11 14:06:39.000000 gine-0.0.4/gine/labextension/static/third-party-licenses.json
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-11 14:06:39.962098 gine-0.0.4/gine/nbextension/
--rw-r--r--   0 runner    (1001) docker     (123)      517 2023-06-11 14:06:32.000000 gine-0.0.4/gine/nbextension/extension.js
--rw-r--r--   0 runner    (1001) docker     (123)     1350 2023-06-11 14:06:32.000000 gine-0.0.4/gine/nbextension/index.js
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-11 14:06:39.962098 gine-0.0.4/gine.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     2470 2023-06-11 14:06:39.000000 gine-0.0.4/gine.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      830 2023-06-11 14:06:39.000000 gine-0.0.4/gine.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-11 14:06:39.000000 gine-0.0.4/gine.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-11 14:06:16.000000 gine-0.0.4/gine.egg-info/not-zip-safe
--rw-r--r--   0 runner    (1001) docker     (123)       87 2023-06-11 14:06:39.000000 gine-0.0.4/gine.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        5 2023-06-11 14:06:39.000000 gine-0.0.4/gine.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       58 2023-06-11 14:05:41.000000 gine-0.0.4/gine.json
--rw-r--r--   0 runner    (1001) docker     (123)      168 2023-06-11 14:05:41.000000 gine-0.0.4/install.json
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-11 14:06:39.966098 gine-0.0.4/js/
--rw-r--r--   0 runner    (1001) docker     (123)      185 2023-06-11 14:05:41.000000 gine-0.0.4/js/README.md
--rw-r--r--   0 runner    (1001) docker     (123)      647 2023-06-11 14:05:41.000000 gine-0.0.4/js/amd-public-path.js
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-11 14:06:39.966098 gine-0.0.4/js/dist/
--rw-r--r--   0 runner    (1001) docker     (123)     1350 2023-06-11 14:06:32.000000 gine-0.0.4/js/dist/index.js
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-11 14:06:39.966098 gine-0.0.4/js/lib/
--rw-r--r--   0 runner    (1001) docker     (123)     1253 2023-06-11 14:05:41.000000 gine-0.0.4/js/lib/example.js
--rw-r--r--   0 runner    (1001) docker     (123)      445 2023-06-11 14:05:41.000000 gine-0.0.4/js/lib/extension.js
--rw-r--r--   0 runner    (1001) docker     (123)      162 2023-06-11 14:05:41.000000 gine-0.0.4/js/lib/index.js
--rw-r--r--   0 runner    (1001) docker     (123)      449 2023-06-11 14:05:41.000000 gine-0.0.4/js/lib/labplugin.js
--rw-r--r--   0 runner    (1001) docker     (123)   213119 2023-06-11 14:05:41.000000 gine-0.0.4/js/package-lock.json
--rw-r--r--   0 runner    (1001) docker     (123)     1743 2023-06-11 14:05:41.000000 gine-0.0.4/js/package.json
--rw-r--r--   0 runner    (1001) docker     (123)     2807 2023-06-11 14:05:41.000000 gine-0.0.4/js/webpack.config.js
--rw-r--r--   0 runner    (1001) docker     (123)   118565 2023-06-11 14:05:41.000000 gine-0.0.4/js/yarn.lock
--rw-r--r--   0 runner    (1001) docker     (123)      145 2023-06-11 14:05:41.000000 gine-0.0.4/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)     1456 2023-06-11 14:06:39.966098 gine-0.0.4/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)      879 2023-06-11 14:05:41.000000 gine-0.0.4/setup.py
...
### Comparing `gine-0.0.4/PKG-INFO` & `gine-0.1.0a0/PKG-INFO`
...
### Comparing `gine-0.0.4/gine/__init__.py` & `gine-0.1.0a0/gine/__init__.py`
...
### Comparing `gine-0.0.4/gine/example.py` & `gine-0.1.0a0/gine/example.py`
...
### Comparing `gine-0.0.4/gine/labextension/package.json` & `gine-0.1.0a0/js/package.json`
...
-        "_build": {
-            "extension": "./extension",
-            "load": "static/remoteEntry.e96430acb17957cafa46.js"
-        },
...
### Comparing `gine-0.0.4/gine/labextension/static/261.eaa1869df03e402b748a.js` & `gine-0.1.0a0/gine/labextension/static/261.26c05cf182529e4a7886.js`
...
### Comparing `gine-0.0.4/gine/labextension/static/461.1bd728bc8c28c2dac706.js` & `gine-0.1.0a0/gine/labextension/static/461.75d29cc6e65f5dc85b41.js`
...
### Comparing `gine-0.0.4/gine/labextension/static/remoteEntry.e96430acb17957cafa46.js` & `gine-0.1.0a0/gine/labextension/static/remoteEntry.3963689fdfb3bdc58b8e.js`
...
@@ -1,12 +1,12 @@
 ...
 (() => {
     "use strict";
-    var e, r, t, n, o, a, i, u, l, f, s, d, p, c, h, v, g = {
-            414: (e, r, t) => {
...
-        261: "eaa1869df03e402b748a",
-        461: "1bd728bc8c28c2dac706",
...
-    }(), m.o = (e, r) => Object.prototype.hasOwnProperty.call(e, r), e = {}, r = "gine:", m.l = (t, n, o, a) => {
...
-                })("gine", "0.0.4"), e[t] = u.length ? Promise.all(u).then((() => e[t] = 1)) : 1
...
### Comparing `gine-0.0.4/gine/nbextension/extension.js` & `gine-0.1.0a0/gine/nbextension/extension.js`

 * *Files identical despite different names*

### Comparing `gine-0.0.4/gine/nbextension/index.js` & `gine-0.1.0a0/gine/nbextension/index.js`
...
### Comparing `gine-0.0.4/gine.egg-info/PKG-INFO` & `gine-0.1.0a0/gine.egg-info/PKG-INFO`
...
### Comparing `gine-0.0.4/js/amd-public-path.js` & `gine-0.1.0a0/js/amd-public-path.js`
...
### Comparing `gine-0.0.4/js/dist/index.js` & `gine-0.1.0a0/js/dist/index.js`
...
### Comparing `gine-0.0.4/js/lib/example.js` & `gine-0.1.0a0/js/lib/example.js`
...
### Comparing `gine-0.0.4/js/webpack.config.js` & `gine-0.1.0a0/js/webpack.config.js`
...
### Comparing `gine-0.0.4/setup.cfg` & `gine-0.1.0a0/setup.cfg`
...
### Comparing `gine-0.0.4/setup.py` & `gine-0.1.0a0/setup.py`
