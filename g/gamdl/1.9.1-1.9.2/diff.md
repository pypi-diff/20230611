# Comparing `tmp/gamdl-1.9.1.tar.gz` & `tmp/gamdl-1.9.2.tar.gz`
...
## Comparing `gamdl-1.9.1.tar` & `gamdl-1.9.2.tar`
...
### Comparing `gamdl-1.9.1/.github/workflows/main.yml` & `gamdl-1.9.2/.github/workflows/main.yml`

 * *Files identical despite different names*

### Comparing `gamdl-1.9.1/README.md` & `gamdl-1.9.2/README.md`
...
### Comparing `gamdl-1.9.1/gamdl/__init__.py` & `gamdl-1.9.2/gamdl/__init__.py`
...
### Comparing `gamdl-1.9.1/gamdl/gamdl.py` & `gamdl-1.9.2/gamdl/gamdl.py`
...
### Comparing `gamdl-1.9.1/gamdl/storefront_ids.py` & `gamdl-1.9.2/gamdl/storefront_ids.py`

 * *Files identical despite different names*

### Comparing `gamdl-1.9.1/PKG-INFO` & `gamdl-1.9.2/PKG-INFO`
