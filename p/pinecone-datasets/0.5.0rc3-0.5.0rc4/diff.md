# Comparing `tmp/pinecone_datasets-0.5.0rc3.tar.gz` & `tmp/pinecone_datasets-0.5.0rc4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pinecone_datasets-0.5.0rc3.tar", max compression
+gzip compressed data, was "pinecone_datasets-0.5.0rc4.tar", max compression
```

## Comparing `pinecone_datasets-0.5.0rc3.tar` & `pinecone_datasets-0.5.0rc4.tar`

### file list

```diff
@@ -1,12 +1,12 @@
--rw-r--r--   0        0        0     8945 2023-06-10 20:04:06.109588 pinecone_datasets-0.5.0rc3/README.md
--rw-r--r--   0        0        0      263 2023-06-11 12:57:00.655456 pinecone_datasets-0.5.0rc3/pinecone_datasets/__init__.py
--rw-r--r--   0        0        0     3088 2023-06-01 03:29:23.061670 pinecone_datasets-0.5.0rc3/pinecone_datasets/catalog.py
--rw-r--r--   0        0        0     1128 2023-06-06 18:16:41.496757 pinecone_datasets-0.5.0rc3/pinecone_datasets/cfg.py
--rw-r--r--   0        0        0    16259 2023-06-11 12:52:17.962187 pinecone_datasets-0.5.0rc3/pinecone_datasets/dataset.py
--rw-r--r--   0        0        0     1765 2023-06-10 19:50:50.284354 pinecone_datasets-0.5.0rc3/pinecone_datasets/ds_utils.py
--rw-r--r--   0        0        0      969 2023-06-09 17:14:09.503269 pinecone_datasets-0.5.0rc3/pinecone_datasets/fs.py
--rw-r--r--   0        0        0     1657 2023-05-31 11:31:31.876795 pinecone_datasets-0.5.0rc3/pinecone_datasets/public.py
--rw-r--r--   0        0        0      227 2023-06-10 19:50:50.277429 pinecone_datasets-0.5.0rc3/pinecone_datasets/testing.py
--rw-r--r--   0        0        0      815 2023-06-11 12:56:53.473828 pinecone_datasets-0.5.0rc3/pyproject.toml
--rw-r--r--   0        0        0    10066 1970-01-01 00:00:00.000000 pinecone_datasets-0.5.0rc3/setup.py
--rw-r--r--   0        0        0     9871 1970-01-01 00:00:00.000000 pinecone_datasets-0.5.0rc3/PKG-INFO
...
### Comparing `pinecone_datasets-0.5.0rc3/README.md` & `pinecone_datasets-0.5.0rc4/README.md`

 * *Files identical despite different names*

### Comparing `pinecone_datasets-0.5.0rc3/pinecone_datasets/catalog.py` & `pinecone_datasets-0.5.0rc4/pinecone_datasets/catalog.py`

 * *Files identical despite different names*

### Comparing `pinecone_datasets-0.5.0rc3/pinecone_datasets/cfg.py` & `pinecone_datasets-0.5.0rc4/pinecone_datasets/cfg.py`

 * *Files identical despite different names*

### Comparing `pinecone_datasets-0.5.0rc3/pinecone_datasets/dataset.py` & `pinecone_datasets-0.5.0rc4/pinecone_datasets/dataset.py`
...
### Comparing `pinecone_datasets-0.5.0rc3/pinecone_datasets/ds_utils.py` & `pinecone_datasets-0.5.0rc4/pinecone_datasets/ds_utils.py`

 * *Files identical despite different names*

### Comparing `pinecone_datasets-0.5.0rc3/pinecone_datasets/fs.py` & `pinecone_datasets-0.5.0rc4/pinecone_datasets/fs.py`

 * *Files identical despite different names*

### Comparing `pinecone_datasets-0.5.0rc3/pinecone_datasets/public.py` & `pinecone_datasets-0.5.0rc4/pinecone_datasets/public.py`

 * *Files identical despite different names*

### Comparing `pinecone_datasets-0.5.0rc3/pyproject.toml` & `pinecone_datasets-0.5.0rc4/pyproject.toml`
...
### Comparing `pinecone_datasets-0.5.0rc3/setup.py` & `pinecone_datasets-0.5.0rc4/setup.py`
...
### Comparing `pinecone_datasets-0.5.0rc3/PKG-INFO` & `pinecone_datasets-0.5.0rc4/PKG-INFO`
