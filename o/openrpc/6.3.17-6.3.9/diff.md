# Comparing `tmp/openrpc-6.3.17.tar.gz` & `tmp/openrpc-6.3.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "openrpc-6.3.17.tar", max compression
+gzip compressed data, was "openrpc-6.3.9.tar", max compression
```

## Comparing `openrpc-6.3.17.tar` & `openrpc-6.3.9.tar`

### file list

```diff
@@ -1,15 +1,15 @@
--rw-r--r--   0        0        0     1072 2023-06-11 20:32:47.734041 openrpc-6.3.17/LICENSE
--rw-r--r--   0        0        0     3193 2023-06-11 20:32:47.734041 openrpc-6.3.17/README.md
--rw-r--r--   0        0        0     1045 2023-06-11 20:32:47.734041 openrpc-6.3.17/openrpc/__init__.py
--rw-r--r--   0        0        0      183 2023-06-11 20:32:47.734041 openrpc-6.3.17/openrpc/_depends.py
--rw-r--r--   0        0        0    11312 2023-06-11 20:32:47.734041 openrpc-6.3.17/openrpc/_discover.py
--rw-r--r--   0        0        0     7539 2023-06-11 20:32:47.734041 openrpc-6.3.17/openrpc/_method_processor.py
--rw-r--r--   0        0        0     5590 2023-06-11 20:32:47.734041 openrpc-6.3.17/openrpc/_method_registrar.py
--rw-r--r--   0        0        0     9488 2023-06-11 20:32:47.734041 openrpc-6.3.17/openrpc/_objects.py
--rw-r--r--   0        0        0     7950 2023-06-11 20:32:47.734041 openrpc-6.3.17/openrpc/_request_processor.py
--rw-r--r--   0        0        0      280 2023-06-11 20:32:47.734041 openrpc-6.3.17/openrpc/_router.py
--rw-r--r--   0        0        0     1168 2023-06-11 20:32:47.734041 openrpc-6.3.17/openrpc/_rpcmethod.py
--rw-r--r--   0        0        0     9047 2023-06-11 20:32:47.735041 openrpc-6.3.17/openrpc/_server.py
--rw-r--r--   0        0        0        0 2023-06-11 20:32:47.757041 openrpc-6.3.17/openrpc/py.typed
--rw-r--r--   0        0        0     1103 2023-06-11 20:32:47.735041 openrpc-6.3.17/pyproject.toml
--rw-r--r--   0        0        0     4203 1970-01-01 00:00:00.000000 openrpc-6.3.17/PKG-INFO
...
### Comparing `openrpc-6.3.17/LICENSE` & `openrpc-6.3.9/LICENSE`

 * *Files identical despite different names*

### Comparing `openrpc-6.3.17/README.md` & `openrpc-6.3.9/README.md`

 * *Files identical despite different names*

### Comparing `openrpc-6.3.17/openrpc/__init__.py` & `openrpc-6.3.9/openrpc/__init__.py`
...
### Comparing `openrpc-6.3.17/openrpc/_discover.py` & `openrpc-6.3.9/openrpc/_discover.py`
...
### Comparing `openrpc-6.3.17/openrpc/_method_processor.py` & `openrpc-6.3.9/openrpc/_method_processor.py`
...
### Comparing `openrpc-6.3.17/openrpc/_method_registrar.py` & `openrpc-6.3.9/openrpc/_method_registrar.py`
...
### Comparing `openrpc-6.3.17/openrpc/_objects.py` & `openrpc-6.3.9/openrpc/_objects.py`
...
### Comparing `openrpc-6.3.17/openrpc/_request_processor.py` & `openrpc-6.3.9/openrpc/_request_processor.py`
...
### Comparing `openrpc-6.3.17/openrpc/_rpcmethod.py` & `openrpc-6.3.9/openrpc/_rpcmethod.py`

 * *Files identical despite different names*

### Comparing `openrpc-6.3.17/openrpc/_server.py` & `openrpc-6.3.9/openrpc/_server.py`
...
### Comparing `openrpc-6.3.17/pyproject.toml` & `openrpc-6.3.9/pyproject.toml`
...
### Comparing `openrpc-6.3.17/PKG-INFO` & `openrpc-6.3.9/PKG-INFO`
