# Comparing `tmp/sqlite_http-0.1.0a5-py3-none-win_amd64.whl.zip` & `tmp/sqlite_http-0.1.0a6-py3-none-win_amd64.whl.zip`
...
+   377fb7df4:	cs ss add %al,(%rax)
 ...
 0000000377fb7e00 <bswapMask>:
    ...
    377fb7e07:	or     %al,(%rdi)
    377fb7e09:	(bad)
@@ -1621883,21 +1621869,18 @@
    377fb927d:	add    %al,(%rax)
    377fb927f:	add    %ah,0x377b615(%rax)
 	...
...
## Comparing `sqlite_http-0.1.0a5.dist-info/METADATA` & `sqlite_http-0.1.0a6.dist-info/METADATA`
...
## Comparing `sqlite_http-0.1.0a5.dist-info/RECORD` & `sqlite_http-0.1.0a6.dist-info/RECORD`
